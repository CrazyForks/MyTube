export const ko = {
  ...
  defaultVideoCodec: "선호 비디오 코덱",
  defaultVideoCodecDescription:
    "다운로드 시 특정 비디오 코덱을 우선 선택합니다. yt-dlp는 가능한 경우 이 코덱을 선택하고, 사용할 수 없으면 다른 코덱으로 대체합니다. 사용자 지정 yt-dlp 설정에 의해 재정의됩니다.",
  defaultVideoCodecDefault: "기본값",
  ...
  telegramNotificationsDescription: "다운로드 작업 완료 시 Telegram으로 알림을 받습니다.",
  telegramEnabled: "Telegram 알림 활성화",
  telegramBotToken: "봇 토큰",
  telegramBotTokenHelper: "Telegram에서 @BotFather를 통해 봇을 만들어 토큰을 받으세요.",
  ...
  telegramTestMissingFields: "먼저 봇 토큰과 채팅 ID를 입력하세요.",
  ...
  refreshFileSizesError: "파일 크기 새로 고침 실패: {error}",
  ...
  rssRoleDescription: "visitor는 공개 비디오만 표시하고 admin은 숨겨진 비디오도 포함합니다. 생성 후에는 역할을 변경할 수 없습니다.",
  rssFilters: "Filters",
